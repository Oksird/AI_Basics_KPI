        ...
        with open("walls.txt", 'r') as file:
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    if char == "C":
                        blocks.append(vec(xidx, yidx))
        # Opening walls file
        # Creating walls list with co-ords of walls
        # stored as  a vector 28x31
        with open("walls.txt", 'r') as file:
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    if char == "1":
                        ...
                        pygame.draw.rect(self.background, (255,0,0), (xidx * self.cell_width, yidx * self.cell_height,
                                                                  self.cell_width, self.cell_height))
                        self.walls.append(vec(xidx,yidx))
    ...
    def reset(self):
        ...
        with open("walls.txt", 'r') as file:
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    if char == 'B':
                        self.blocks.append(vec(xidx, yidx))
        self.state = "playing"
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def draw_blocks(self):
        for x in range(4):
            rnd = random.randint(0,len(self.coins)-1)
            pygame.draw.circle(self.screen, (255, 0, 0),
                               (int(self.coins[rnd].x*self.cell_width)+self.cell_width//2+TOP_BOTTOM_BUFFER//2,
                                int(self.coins[rnd].y*self.cell_height)+self.cell_height//2+TOP_BOTTOM_BUFFER//2), 5)
